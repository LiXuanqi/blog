...
export function PostCard({ data, actions, appearance }: PostCardProps) {
  ...
  const hideAction = appearance?.hideAction ?? false;
    ...
    return (
      <div className="flex h-full flex-col justify-between rounded-lg border bg-card p-3">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          {!hideAction ? renderReadButton("Read more", { size: "sm" }) : null}
        </div>
      </div>
    );
  }
    ...
    <div className="flex h-full flex-col overflow-hidden rounded-lg border bg-card">
      ...
      <div className="flex flex-1 flex-col justify-between p-4">
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {!hideAction ? renderReadButton("Read", { size: "sm" }) : null}
        </div>
      </div>
    </div>
  );
